...
class ZBWorker extends events_1.EventEmitter {
    ...
    async handleJob(job) {
        ...
        try {
            ...
            const workerCallback = {
                error: async (errorCode, errorMessage = '') => {
                    try {
                        ...
                        this.logger.debug(`Errored job ${job.key} - ${errorMessage}`);
                        this.drainOne();
                    }
                },
                ...
                success: async (completedVariables = {}) => {
                    ...
                    try {
                        ...
                        res = e;
                        this.logger.debug(`Completing task ${taskId} for ${this.taskType} threw ${e.message}`);
                    }
                    this.drainOne();
                    return res;
                },
...
ZBWorker.DEFAULT_JOB_ACTIVATION_TIMEOUT = 60000;
ZBWorker.DEFAULT_MAX_ACTIVE_JOBS = 32;
