...
class ConfigurationHydrator {
    static configure(gatewayAddress, options) {
        ...
        const configuration = {
            ...
            ...ConfigurationHydrator.readCamundaClusterConfFromEnv(gatewayAddress),
    ...
    static readOAuthFromEnvironment() {
    ...
    static getGatewayFromEnvironment() {
        ...
        const connectionString = process.env.ZEEBE_GATEWAY_ADDRESS || process.env.ZEEBE_ADDRESS;
