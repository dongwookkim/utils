...
export declare type Loglevel = 'INFO' | 'DEBUG' | 'NONE' | 'ERROR';
export interface CompleteFn<WorkerOutputVariables> {
     ...
     */
    success: (updatedVariables?: Partial<WorkerOutputVariables>) => Promise<boolean>;
    /**
...
export declare type ZBWorkerTaskHandler<WorkerInputVariables = GenericWorkerInputVariables, CustomHeaderShape = GenericWorkerOutputVariables, WorkerOutputVariables = GenericCustomHeaderShape> = (job: Job<WorkerInputVariables, CustomHeaderShape>, complete: CompleteFn<WorkerOutputVariables>, worker: ZBWorker<WorkerInputVariables, CustomHeaderShape, WorkerOutputVariables>) => void;
...
export interface ZBGRPC extends GRPCClient {
    ...
    publishMessageSync(publishMessageRequest: PublishMessageRequest): Promise<void>;
    ...
    createWorkflowInstanceSync(createWorkflowInstanceRequest: CreateWorkflowInstanceRequest): Promise<CreateWorkflowInstanceResponse>;
    createWorkflowInstanceWithResultSync<Result>(createWorkflowInstanceWithResultRequest: CreateWorkflowInstanceWithResultRequest): Promise<CreateWorkflowInstanceWithResultResponse<Result>>;
