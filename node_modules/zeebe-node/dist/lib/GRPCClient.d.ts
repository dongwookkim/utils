...
export declare class GRPCClient extends EventEmitter {
    ...
    private basicAuth?;
    constructor({ basicAuth, connectionTolerance, host, loglevel, oAuth, options, packageName, protoPath, service, namespace, tasktype, useTLS, stdout, onConnectionError, onReady, }: {
