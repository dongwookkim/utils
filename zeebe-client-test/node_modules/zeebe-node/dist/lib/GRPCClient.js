...
class GRPCClient extends events_1.EventEmitter {
    constructor({ basicAuth, connectionTolerance, host, loglevel, oAuth, options = {}, packageName, protoPath, service, tasktype, useTLS, stdout = console, onConnectionError, onReady, }) {
        super();
