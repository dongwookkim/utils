...
reqVoice = _reflection.GeneratedProtocolMessageType('reqVoice', (_message.Message,), {
...
reqVoiceOpt = _reflection.GeneratedProtocolMessageType('reqVoiceOpt', (_message.Message,), {
...
resText = _reflection.GeneratedProtocolMessageType('resText', (_message.Message,), {
  'DESCRIPTOR' : _RESTEXT,
  '__module__' : 'gigagenieRPC_pb2'
...
reqText = _reflection.GeneratedProtocolMessageType('reqText', (_message.Message,), {
  'DESCRIPTOR' : _REQTEXT,
  '__module__' : 'gigagenieRPC_pb2'
...
resUrl = _reflection.GeneratedProtocolMessageType('resUrl', (_message.Message,), {
  'DESCRIPTOR' : _RESURL,
  '__module__' : 'gigagenieRPC_pb2'
...
resVoice = _reflection.GeneratedProtocolMessageType('resVoice', (_message.Message,), {
...
resVoiceResult = _reflection.GeneratedProtocolMessageType('resVoiceResult', (_message.Message,), {
...
reqQueryText = _reflection.GeneratedProtocolMessageType('reqQueryText', (_message.Message,), {
...
resQueryText = _reflection.GeneratedProtocolMessageType('resQueryText', (_message.Message,), {
...
dssAction = _reflection.GeneratedProtocolMessageType('dssAction', (_message.Message,), {
...
reqQueryVoice = _reflection.GeneratedProtocolMessageType('reqQueryVoice', (_message.Message,), {
...
reqQueryVoiceOpt = _reflection.GeneratedProtocolMessageType('reqQueryVoiceOpt', (_message.Message,), {
...
resQueryByVoice = _reflection.GeneratedProtocolMessageType('resQueryByVoice', (_message.Message,), {
